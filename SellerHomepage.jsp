...
<div class="main">
	...
	try{
		...
		{
		%>
		<h1 style="text-align:center;">Welcome <%=rs.getString("sname")%>!</h1>
		<div class="filler2"></div>
			<div class="card">
  				<img src="images/vendor.jpg" class="Avatar" width=264 height=234>
  				<div class="container">
    				<h2><b><%=rs.getString("sname") %></b></h2>
   					<p text-align="left"><b>ID: </b><%=rs.getString("sid") %> </p>
