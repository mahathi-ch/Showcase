...
<div class="main">
	...
	<div class="header">
		<div class="container2">
			...
			<a style="float:right; margin-top: 8px; text-decoration:none;" href ="Search.jsp">
...
<div class="active">
    ...
    String query="select p.pname,p.pid,p.manufacturer,p.mfg,p.price,p.ptype,i.quantity from product p,inventory i where p.pid=i.pid AND p.pname =? ";
