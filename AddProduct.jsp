...
<body>
	...
	<%
		...
		String query4="select sname from seller where sid=?";
		String query1="select pid from product where pid=?";
		String query2="insert into product(pid,pname,manufacturer,mfg,exp,price,ptype) values (?,?,?,?,?,?,?)";
		...
		try{
			...
			ps4.setString(1,guid);
			rs = ps4.executeQuery();
			rs.next();
			String mfname = rs.getString(1);
